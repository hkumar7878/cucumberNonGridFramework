...
,glue = {"steps1"}
,monochrome = true, 
tags = {"~@test","@Search-New-Car-Positive"},
dryRun=false,
plugin = {
		"json:target/positive/cucumber.json", "pretty",
		"html:target/positive/cucumber.html",
		"com.cucumber.listener.ExtentCucumberFormatter"
		 })
public class Runner_NewCarSearch_TestNG extends AbstractTestNGCucumberTests{

	@BeforeClass
    public static void setup() {
		try{
			
			System.out.println(" Inside runner before class method");
